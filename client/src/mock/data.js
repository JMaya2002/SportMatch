...
export const MOCK_USERS = [
  ...
  { id: 2, username: 'elena',   name: 'Elena Soler',     age: 26, city: 'Barcelona', main_sport: 'tenis',     level: 'avanzado',
  ...
  { id: 5, username: 'alex',    name: 'Alex Torres',     age: 30, city: 'Barcelona', main_sport: 'baloncesto', level: 'avanzado',
