...
export const MOCK_USERS = [
  { id: 1, username: 'joel',    name: 'Joel Maya',       age: 28, city: 'Barcelona', province: 'Barcelona', main_sport: 'padel',      sports: ['padel', 'tenis'],                    level: 'intermedio',
    avatar_url: 'https://i.pravatar.cc/200?img=12', bio: 'Pádel los sábados por la mañana. Busco compañeros para subir nivel.' },
  { id: 2, username: 'elena',   name: 'Elena Soler',     age: 26, city: 'Barcelona', province: 'Barcelona', main_sport: 'tenis',      sports: ['tenis'],                             level: 'experto',
    avatar_url: 'https://i.pravatar.cc/200?img=45', bio: 'Tenis competitivo. Disponible tardes entre semana.' },
  { id: 3, username: 'carlos',  name: 'Carlos Ruiz',     age: 34, city: 'Madrid',    province: 'Madrid',    main_sport: 'futbol',     sports: ['futbol', 'running'],                 level: 'intermedio',
    avatar_url: 'https://i.pravatar.cc/200?img=33', bio: 'Fútbol 7 los miércoles. Capitán del equipo Real Polígono.' },
  { id: 4, username: 'marta',   name: 'Marta López',     age: 22, city: 'Valencia',  province: 'Valencia',  main_sport: 'running',    sports: ['running'],                           level: 'principiante',
    avatar_url: 'https://i.pravatar.cc/200?img=47', bio: 'Empezando a correr. Busco grupo para 5K los domingos.' },
  { id: 5, username: 'alex',    name: 'Alex Torres',     age: 30, city: 'Barcelona', province: 'Barcelona', main_sport: 'baloncesto', sports: ['baloncesto', 'futbol'],               level: 'experto',
    avatar_url: 'https://i.pravatar.cc/200?img=15', bio: 'Baloncesto 3x3. Pista del parque de la Ciutadella.' },
  { id: 6, username: 'lucia',   name: 'Lucía García',    age: 29, city: 'Madrid',    province: 'Madrid',    main_sport: 'padel',      sports: ['padel', 'tenis'],                    level: 'avanzado',
    avatar_url: 'https://i.pravatar.cc/200?img=49', bio: 'Pádel competitivo, busco partidos de nivel.' },
  { id: 7, username: 'diego',   name: 'Diego Hernández', age: 31, city: 'Barcelona', province: 'Barcelona', main_sport: 'ciclismo',   sports: ['ciclismo', 'senderismo'],            level: 'intermedio',
    avatar_url: 'https://i.pravatar.cc/200?img=53', bio: 'Salidas en grupo por Collserola los fines de semana.' },
  { id: 8, username: 'sara',    name: 'Sara Martínez',   age: 25, city: 'Valencia',  province: 'Valencia',  main_sport: 'fitness',    sports: ['fitness'],                           level: 'intermedio',
    avatar_url: 'https://i.pravatar.cc/200?img=24', bio: 'Crossfit y funcional. Compañeros de gym bienvenidos.' },
  { id: 9, username: 'pablo',   name: 'Pablo Sánchez',   age: 27, city: 'Sevilla',   province: 'Sevilla',   main_sport: 'senderismo', sports: ['senderismo', 'ciclismo', 'running'], level: 'avanzado',
    avatar_url: 'https://i.pravatar.cc/200?img=68', bio: 'Rutas largas en Sierra Norte. Nivel exigente.' },
  { id: 10, username: 'nuria',  name: 'Nuria Vidal',     age: 33, city: 'Barcelona', province: 'Barcelona', main_sport: 'tenis',      sports: ['tenis', 'padel'],                    level: 'intermedio',
...
export const MOCK_MEETUPS = [
  { id: 1, creator: MOCK_USERS[0], title: 'Partido de pádel — domingo mañana',
    sport: 'padel', level: 'intermedio', city: 'Barcelona', province: 'Barcelona', location: 'Club Pádel Sant Cugat',
  ...
  { id: 2, creator: MOCK_USERS[2], title: 'Fútbol 7 los miércoles',
    sport: 'futbol', level: 'intermedio', city: 'Madrid', province: 'Madrid', location: 'Campo municipal de Carabanchel',
  ...
  { id: 3, creator: MOCK_USERS[3], title: 'Carrera 5K — Domingo del Turia',
    sport: 'running', level: 'principiante', city: 'Valencia', province: 'Valencia', location: 'Jardín del Turia',
  ...
  { id: 4, creator: MOCK_USERS[4], title: '3x3 Baloncesto en la Ciutadella',
    sport: 'baloncesto', level: 'avanzado', city: 'Barcelona', province: 'Barcelona', location: 'Parc de la Ciutadella',
  ...
  { id: 5, creator: MOCK_USERS[6], title: 'Ruta ciclista por Collserola',
    sport: 'ciclismo', level: 'intermedio', city: 'Barcelona', province: 'Barcelona', location: 'Salida desde Vallvidrera',
  ...
  { id: 6, creator: MOCK_USERS[1], title: 'Tenis nivel avanzado',
    sport: 'tenis', level: 'avanzado', city: 'Barcelona', province: 'Barcelona', location: 'Club Tennis Pompeia',
